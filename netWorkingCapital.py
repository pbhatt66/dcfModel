...
class netWorkingCapital:
    def __init__(self, balance_sheet_data, income_statement_data, cash_flow_data):
    ...
    def generateAssumptions(self):
        ...
        fcf = freeCashFlow(self.cash_flow_data, self.income_statement_data, self.netWorkingCapital, pd.DataFrame())
        proj = fcf._calculate_assumptions()
        revenue_growth_rate = proj["revenue_growth_rate"]
        cogs_as_percentage_of_revenue = proj["cogs_percentage_of_revenue"]
